...
(function () {
   ...
   */
  PrimeGL.Tools.genSprite = function(sx,sy,sw,sh,tx,ty,tu,tv,z,offidx,flip,webprime)    {
      var RetData = [ [], [], [] ];   //  VertexData, TextureData, IndexData
      var SXS = 2 / webprime.config.width,
          SYS = 2 / webprime.config.height;

      flip = flip || false;
      
      sy = webprime.config.height - sy;   //  GL Coordinates are inverted

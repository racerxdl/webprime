...
(function () {
  ...
  Effects.FlashEffect = function(webprime, drawer, gl)    {
    ...
    if(!this.webprime.config.gameVariables.webGLEnabled)
      ...
      this.EffectTexture.width = PrimeGL.nextHighestPowerOfTwo(this.width); 
      this.EffectTexture.height = PrimeGL.nextHighestPowerOfTwo(this.height); 

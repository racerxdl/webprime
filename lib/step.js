...
(function () {
  ...
  var StepSplit  = function (parameters)   {
    ...
    this.Noteskin       =   parameters.Noteskin     || null;
  };
  ...
  StepRow.prototype.AddNote = function(note)     { 
    if (this.Noteskin !== null)
      note.seed = this.Noteskin;

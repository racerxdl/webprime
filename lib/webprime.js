...
(function () {
  ...
  webPrime.createdCallback = function() {
    ...
    this.gameVariables = {
      ...
      offsetY: 32,
      comboNumberWidth: this.graphicalMode === "SD" ? 50 : 72,
      comboNumberHeight: this.graphicalMode === "SD" ? 42 : 60,
      comboNameWidth: this.graphicalMode === "SD" ? 107 : 160,
      comboNameHeight: this.graphicalMode === "SD" ? 22 : 30,
      comboNameX: this.graphicalMode === "SD" ? 152 : 218,
      comboNameY: this.graphicalMode === "SD" ? 42 : 60,
      doubleNotesX: [],
      singleNotesX: [],
  ...
  // Modern Custom Elements v1 registration (preserves all original behavior)
  class WebPrimeElement extends HTMLElement {
    constructor() {
      super();
      Object.assign(this, webPrime);
    }
    connectedCallback() {
      if (this._ceInitialized) return;
      this._ceInitialized = true;
      webPrime.createdCallback.call(this);
    }
  }
  customElements.define('web-prime', WebPrimeElement);

...
(function () {
  ...
  var F2Skin = function(parameters)  {
    ...
    console.log(this.NoteSkinXStep, this.NoteSkinYStep); 
    ...
    loader.onload = function()  {
      ...
      for (var i=0;i<6;i++) {
        ...
        _skin.ItemImage[i].src = this.GetHTMLDataURIFile("/"+(_skin.webprime.graphicalMode.toUpperCase())+"/"+i+PrimeConst.png,PrimeConst.mimepng); 
      }    
    };
    ...
    loader.onload = function()  {
      BaseImage.onload = function() { 
        ...
        if (!_this.webprime.config.runningWebGL)   {
          ...
          _this.BaseInactive   =   ImageTools.cropImage(BaseImage,_skin.webprime.gameVariables.arrowSize / 2 ,-1,_skin.webprime.gameVariables.arrowSize * 4,_skin.webprime.gameVariables.arrowSize); 
        }else{
      ...
      BaseImage.src = this.GetHTMLDataURIFile("/"+(_skin.webprime.graphicalMode.toUpperCase())+PrimeConst.BaseImage,PrimeConst.mimepng);
      ...
      for (var i=0;i<6;i++)    {
        ...
        Frame.src = this.GetHTMLDataURIFile("/"+(_skin.webprime.graphicalMode.toUpperCase())+"/"+i+PrimeConst.png.toUpperCase(),PrimeConst.mimepng);
      }
      ...
      for (i=0;i<5;i++)    {
        ...
        Frame2.src = this.GetHTMLDataURIFile("/"+(_skin.webprime.graphicalMode.toUpperCase())+PrimeConst.StepFXBase+PrimeTools.Pad(_this.number,2)+"_"+i+PrimeConst.png.toUpperCase(),PrimeConst.mimepng);

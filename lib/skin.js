...
(function () {
  ...
  var F2Skin = function(parameters)  {
    ...
    //  TODO FLEXIBLE SD/HD
    this.NoteSkinWidth = PrimeGL.Tools.nextHighestPowerOfTwo(320);
    this.NoteSkinHeight = PrimeGL.Tools.nextHighestPowerOfTwo(192);
    this.NoteSkinXStep = 1.0 / this.NoteSkinWidth;  //  1 / above Width
    this.NoteSkinYStep = 1.0 / this.NoteSkinHeight;  

    this.ItemSkinWidth = PrimeGL.Tools.nextHighestPowerOfTwo(2048);
    this.ItemSkinHeight = PrimeGL.Tools.nextHighestPowerOfTwo(128);
  ...
  NoteSkin.prototype.Load = function () {
    ...
    loader.onload = function()  {
      ...
      for(var i=0;i<6;i++)    {
        ...
        Frame.src = this.GetHTMLDataURIFile("/"+i+PrimeConst.png.toUpperCase(),PrimeConst.mimepng);
      }
      ...
      for(i=0;i<5;i++)    {
        ...
        Frame2.src = this.GetHTMLDataURIFile(PrimeConst.StepFXBase+PrimeTools.Pad(_this.number,2)+"_"+i+PrimeConst.png.toUpperCase(),PrimeConst.mimepng);

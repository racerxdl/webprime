    ...
    while(i<lines.length)    {
      if (lines[i][0] === ":")  {
        ...
        switch(command[0])  {
          ...
          case "Mode"         :   UCSData.Mode   = command[1]; webprime.gameVariables.songIsDouble = (UCSData.Mode.toLowerCase().trim() === "double") || (UCSData.Mode.toLowerCase().trim() === "d-performance"); break;
          ...
          case "MysteryBlock" :
            CurSplit.mysteryblockT = parseFloat(command[1]);
            break;
        ...
        if (CurSplit.mysteryblock === null) {
          ...
          if (CurSplit.mysteryblockT !== null)
            CurSplit.mysteryblock *= CurSplit.mysteryblockT;

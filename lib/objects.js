...
(function () {
  ...
  AnimatedObject.prototype.GLUpdate  = function()  {
    if (this.NeedsRedraw)    {
      var data = PrimeGL.Tools.genSprite(this.x,this.y,this.coord[2]-this.coord[0],this.coord[3]-this.coord[1],this.coord[0]*this.image.XStep,this.coord[1]*this.image.YStep,this.coord[2]*this.image.XStep,this.coord[3]*this.image.YStep,1,0);
